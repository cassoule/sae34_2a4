...
$dbh = new PDO($dsn, $utilisateur, $mot_de_passe);
...
function maFonction($dbh, $mois, $annee, $id_logement) {
    

// mois et années actuelle
...
<div id="calendrier-complet">
    ...
    <p id="moisPrecedent">Mois précédent</p>
    <h2><?php echo date("F Y", $premierJour); ?></h2>
    <p id="moisSuivant">Mois suivant</p>
...
maFonction($dbh, $mois, $annee, $id_logement);
...
*/
    ...
    function stopPropagation(event) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var moisActuel = <?php echo $mois; ?>;
            var anneeActuelle = <?php echo $annee; ?>;
            ...
            document.getElementById('moisPrecedent').addEventListener('click', function() {
                moisActuel = moisActuel === 1 ? 12 : moisActuel - 1;
                anneeActuelle = moisActuel === 12 ? anneeActuelle - 1 : anneeActuelle;
                console.log(<?php echo $mois; ?>);
                mettreAJourCalendrier();
            });

            document.getElementById('moisSuivant').addEventListener('click', function() {
                moisActuel = moisActuel === 12 ? 1 : moisActuel + 1;
                anneeActuelle = moisActuel === 1 ? anneeActuelle + 1 : anneeActuelle;
                mettreAJourCalendrier();
            });
        });
