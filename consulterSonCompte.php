...
// Informations liées au compte de l'utilisateur
...
$stmtCompte->execute();
$compteUtilisateur = $stmtCompte->fetch(PDO::FETCH_ASSOC);

$stmtAdresse = $dbh->prepare("SELECT * FROM SAE._adresse WHERE id_adresse = :id_adresse");
$stmtAdresse->bindParam(':id_adresse', $compteUtilisateur['id_adresse']);
$stmtAdresse->execute();
$adresseUtilisateur = $stmtAdresse->fetch(PDO::FETCH_ASSOC);
...
<html lang="fr">
    ...
    <body>
        ...
        <main class="top-svg-main">
            ...
            <div id="consulter_mon_compte">
                <div class="colonne_gauche">
                    <div id=pdp class=info_perso>
                        <?php
                        $stmtImage = $dbh->prepare("SELECT * FROM SAE._image WHERE id_compte = :id_compte");
                        $stmtImage->bindParam(':id_compte', $compteUtilisateur['id_compte']);
                        $stmtImage->execute();
                        $imageUtilisateur = $stmtImage->fetch(PDO::FETCH_ASSOC);
                        if (empty($imageUtilisateur)){
                            $imageUtilisateur= "./img/photo_de_profil_neutre.png";
                        }
                        ?>
                        <img class="pdp" src="<?php echo $imageUtilisateur['lien_image'] ?>" alt="Photo de profil">
                    </div>
                </div>
                <div class="colonne_milieu">
                    <div class=info_perso>
                        <div class=info_perso_content>
                            <h4> <?php echo $adresseUtilisateur['adresse'] ?></h4>
                        </div>
                        <div class=info_perso2>
                            <div class=info_perso_content>
                                <h4> <?php echo $adresseUtilisateur['code_postal'] ?></h4>
                            </div>
                            <div class=info_perso_content>
                                <h4> <?php echo $adresseUtilisateur['ville'] ?></h4>
                            </div>
                        </div>
                        <div class=info_perso_content>
                            <h4><?php echo $adresseUtilisateur['complement_adresse'] ?></h4>
                        </div>
                    </div>
                    <div class=info_perso>
                        <div class=info_perso2>
                            <div class=info_perso_content>
                                <h4><?php echo $compteUtilisateur['nom'] ?></h4>
                            </div>
                            <div class=info_perso_content>
                                <h4><?php echo $compteUtilisateur['prenom'] ?></h4>
                            </div>
                        </div>
                        <div class=info_perso2>
                            <div class=info_perso_content>
                                <h4><?php echo $compteUtilisateur['email'] ?></h4>
                            </div>
                            <div class=info_perso_content>
                                <h4><?php echo $compteUtilisateur['telephone'] ?></h4>
                            </div>
                ...
                <div class="colonne_droite">
                    <div class=info_perso>
                        <div class="info_perso2">
                            ...
                            ?>
                                <form action="/mesReservationsClients.php" method="post">
                                    <input type="submit" value="Voir mes réservations">
                                </form>
                            <?php
                            } else {
                            ?>
                                <form action="/mesReservationsProprietaires.php" method="post">
                                    <input type="submit" value="Voir mes réservations">
                                </form>
                            <?php
                            }
                        ...
                        <div class="info_perso2">
                            ...
                            if ($proprietaire == false) {
                            ?>
                                <form action="/modifierCompteClient.php" method="post">
                                    <input type="submit" value="Modifier mon compte">
                                </form>
                            <?php
                            } else {
                            ?>
                                <form action="/modifierCompteProprietaire.php" method="post">
                                    <input type="submit" value="Modifier mon compte">
                                </form>
                            <?php
                            }
                        ...
                        <div class="info_perso2">
                            ...
                            ?>
                                <form action="/cle.php" method="post">
                                    <input type="submit" value="Gérer mes clés">
                                </form>
                            <?php
                            } ?>
                        </div>
                        <div class="info_perso2">
                            ...
                            if ($proprietaire == true) {
                                ?>
                                    <form action="/cleCalendrier.php" method="post">
                                        <input type="submit" value="Gérer mes calendrier">
                                    </form>
                                <?php
                                }
            ...
            <div class="ligne_du_bas">
                <form  action="/supprimerCompte.php?idCompte=<?php echo $compteUtilisateur['id_compte'] ?>" method="post">
                    <input id="supprimer_compte" type="submit" value="Supprimer mon compte">
                </form>

                <form  action="/index.php?deconnexion=true" method="post">
                    <input id="deconnecter_compte" type="submit" value="Se déconnecter">
                </form>
            </div>
        </main>
